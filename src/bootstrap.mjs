...
function patchOpenClawJson() {
  ...
  // Register Qwen3.5 models with Alibaba DashScope provider (secondary).
  // DashScope provides native OpenAI-compatible function calling for all Qwen models.
  if (process.env.AI_PROVIDER?.trim()?.toLowerCase() === "dashscope") {
    merged.models = merged.models || {};
    merged.models.mode = "merge";
    merged.models.providers = merged.models.providers || {};
    merged.models.providers.dashscope = merged.models.providers.dashscope || {
      baseUrl: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1",
      apiKey: "${DASHSCOPE_API_KEY}",
      api: "openai-completions",
      models: [
        { id: "qwen3.5-35b-a3b", name: "Qwen3.5 35B A3B", reasoning: false, contextWindow: 262144, maxTokens: 32768 },
        { id: "qwen3.5-27b", name: "Qwen3.5 27B", reasoning: false, contextWindow: 262144, maxTokens: 32768 },
        { id: "qwen3.5-397b-a17b", name: "Qwen3.5 397B A17B", reasoning: false, contextWindow: 262144, maxTokens: 32768 },
        { id: "qwen3.5-122b-a10b", name: "Qwen3.5 122B A10B", reasoning: false, contextWindow: 262144, maxTokens: 32768 },
        { id: "qwen3.5-plus", name: "Qwen3.5 Plus", reasoning: false, contextWindow: 262144, maxTokens: 32768 },
        { id: "qwen3.5-flash", name: "Qwen3.5 Flash", reasoning: false, contextWindow: 262144, maxTokens: 32768 },
      ],
    };
    console.log("[bootstrap] DashScope (Alibaba) provider configured with Qwen3.5 models");
  }
