...
export const DESIRED_MODELS = {
  ...
  // ── Google Cloud Vertex AI (self-hosted vLLM) ──
  "vertex/gemma-4-31b-it": { alias: "Gemma 4 31B IT (Vertex AI)" },

  // ── Alibaba DashScope (Qwen native API) ──
  "dashscope/qwen3.5-35b-a3b": { alias: "Qwen3.5 35B A3B" },
  "dashscope/qwen3.5-27b": { alias: "Qwen3.5 27B" },
  "dashscope/qwen3.5-397b-a17b": { alias: "Qwen3.5 397B A17B" },
  "dashscope/qwen3.5-122b-a10b": { alias: "Qwen3.5 122B A10B" },
  "dashscope/qwen3.5-plus": { alias: "Qwen3.5 Plus" },
  "dashscope/qwen3.5-flash": { alias: "Qwen3.5 Flash" },
...
export const PROVIDER_DEFAULTS = [
  ...
  { key: "VERTEX_SA_KEY", model: "vertex/gemma-4-31b-it" },
  { key: "DASHSCOPE_API_KEY", model: "dashscope/qwen3.5-35b-a3b" },
...
export const AI_PROVIDER_MODEL_MAP = {
  ...
  dashscope: "dashscope/qwen3.5-35b-a3b",
